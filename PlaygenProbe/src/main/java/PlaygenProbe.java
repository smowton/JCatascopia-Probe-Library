...
public class PlaygenProbe extends Probe{
	
	private static final String CONFIG_PATH = "playgen.properties";
	private Properties config;
	private String playgen_url;

	public PlaygenProbe(String name, int freq) {
		super(name, freq);
	...
	public PlaygenProbe(){
		this("PlaygenProbe",30);
	}
	
	@Override
	public String getDescription() {
		return "PlaygenProbe collect's Playgen DataPlay master node stats";
	}
...
//		}
	...
	public static void main(String[] args) {
		PlaygenProbe probe = new PlaygenProbe();
		probe.activate();
	}
}
